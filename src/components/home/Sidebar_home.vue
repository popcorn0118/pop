<template>
    <div class="col-md-3">
        ...
        <div class="list-group sticky-top">
            <router-link to="/home/products" class="list-group-item list-group-item-action active" data-toggle="list"><i class="fa fa-suitcase" aria-hidden="true"></i> 金牌專賣店</router-link>
